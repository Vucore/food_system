...
class FoodModelPredictorSwin:
    """Class để tải model Swin Transformer và dự đoán hình ảnh thức ăn"""

    def __init__(self, model_path: str, class_names: Optional[list] = None, num_classes: int = 30):
        """
        Khởi tạo FoodModelPredictorSwin
...
def create_predictor(model_path: str, class_names: Optional[list] = None) -> FoodModelPredictorSwin:
    """
    ...
    Returns:
        FoodModelPredictorSwin instance
    """
    return FoodModelPredictorSwin(model_path, class_names)